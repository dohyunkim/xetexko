...
\begin{quote}\small
  ...
  \begin{itemize}\itemsep=0pt
    ...
    \item \verb|interpunctskern| 글꼴 옵션을 없애고
      \verb|quoteraise| 및 \verb|charraise| (v2.2)를 추가했다.
    \item \verb|\fallbackhanjafont| 명령을 추가했다. (v2.2)
    \item \verb|\everyhangul|, \verb|\everyhanja| 명령이 추가되었다. (v2.2)
  \end{itemize}
\end{quote}
...
\begin{description}
  \item[\cs{everyhangul}, \cs{everyhanja}]
    ...
    \verb|\everyhangul{\fbox{#1}}| 명령은 모든 한글 주위에 박스를
